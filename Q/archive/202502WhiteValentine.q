...
Dim ActvityActionRounds = Array(_
	Array(_
		Array(_
			Array("skill",  70, 92, 10, 20, 32, 40, 50, 62),_
...
Dim ArtActionRounds = Array(_
	Array(_
		Array(_
			Array("skill",  2,3, 3,3, 5,3, 6,3, 7,0, 9,0),_
			Array("master", 2,3),_
...
Function DoSkillActions(ActionsGroup)
	...
	For ActionIndex = 1 To ActionsCount
		Dim SkillIndex = Int(ActionsGroup[ActionIndex+1]/10)
		TracePrint "skill", SkillIndex
		Dim SkillTargetIndex = ActionsGroup[ActionIndex+1] Mod 10
