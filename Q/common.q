...
Dim xufu_yichui_AllActionRound = Array(_
	Array(_
		Array("skill",  1,0, 2,0, 4,0, 6,3, 7,0, 8,3),_
		Array("attack", 8,4,5)_
	),_
	Array(_
		Array("skill",  3,3, 5,3),_
		Array("attack", 8,4,5)_
	),_
	Array(_
		Array("skill",  9,0),_
...
Dim AllActionRound = xufu_yichui_AllActionRound
...
Dim BATTLE_ATTACK_CARD_SECON_TAPED_TARS = Array(_
	...
	Array(),_
	Array(),_
	Array(704, 227, 727, 238, "Attachment:BATTLE_ATTACK_CARD_7_SECOND_TAPED.png"),_
