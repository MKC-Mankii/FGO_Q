...
launcher_script = os.path.join(root_dir, "editor_v4", "launcher.py")
ico_path = os.path.join(root_dir, "editor_v4", "icons", "fgo_editor.ico")
...
shortcut_name = "FGO_Config_Editor_V4.lnk"
...
lnk1.Description = "FGO Q Battle Config Editor (V4)"
lnk1.Save
...
lnk2.Description = "FGO Q Battle Config Editor (V4)"
lnk2.Save

WScript.Echo "Shortcuts successfully created!"
'''

temp_vbs = os.path.join(root_dir, "editor_v4", "temp_create_lnk.vbs")
