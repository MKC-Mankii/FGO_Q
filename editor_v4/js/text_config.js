...
export const TEXT_CONFIG = {
    ...
    masthead: {
        ...
        syncReading: "⏳ 读取中...",
        syncSuccess: "✅ 配置已就绪",
        syncLocalFallback: "⚠️ 本地临时缓存",
        syncSavedDisk: "✅ 已保存并直推",
        syncSaveError: "❌ 保存失败: {error}",
        btnReload: "📂 重新读取",
    ...
    // 1.5 全局运行参数 (Runner Settings - v4 新增)
    runnerSettings: {
        title: "运行参数",
        titleTooltip: "全局战斗运行配置（启动时生效，支持在页面上直接调整与保存）",
        activeGroupLabel: "🎯 选择战场",
        activeGroupTitle: "选择当前战场大组（同时作为脚本默认执行的目标战场）",
        battleCountLabel: "⚔️ 战斗轮数",
        battleCountTitle: "连续自动战斗的最大轮数",
        appleEnableLabel: "🍎 吃苹果补体力",
        appleEnableTitle: "体力不足时是否自动吃苹果补充（默认关）",
        manualFriendLabel: "🤝 人工选助战",
        manualFriendTitle: "开启后跳过助战特征识别，等待玩家人工选择（默认关）",
        forceColorLabel: "🎨 强制选色卡",
        forceColorTitle: "是否强制选择指令指定的色卡（红/蓝/绿）（默认关）"
    },
    ...
    sidebar: {
        ...
        btnDeleteSchemeTitle: "删除方案 (双击确认)",
        btnDeleteSchemeConfirm: "⚠️ 确认删除？",
        cannotDeleteOnlySchemeToast: "⚠️ 每个战场至少需保留 1 个方案，无法删除",
        schemeDeletedToast: "🗑️ 已删除方案：{name}",
        defaultTag: "(默认方案)",
        defaultBadge: "⭐",
        friendPrefix: "助战: ",
        noFriend: "无助战",
    ...
    schemeBar: {
        ...
        defaultTagActive: "⭐",
        defaultTagActiveTitle: "⭐ 当前方案为默认执行方案（选中即生效）",
        btnCopyDsl: "📋 复制 DSL",
    ...
    messages: {
        ...
        copyFail: "❌ 复制失败，请重试",
        saveSuccess: "✅ 配置已直接保存至 Q/battle_v4_config.q",
